    ...
    <div class="controls">
      ...
      <VMenu location="bottom" transition="fade-transition">
        ...
        <div class="picker-wrap">
          <VColorPicker v-model="backgroundColor" mode="hexa" hide-inputs/>
        </div>
      </VMenu>
    </div>
...
.select { padding: 10px 12px; border-radius: 10px; border: 1px solid var(--border); background: var(--surface-2); color: var(--text); }
.ratio-inputs { display: inline-flex; align-items: center; gap: 6px; }
.ratio-input { width: 72px; padding: 10px 12px; border-radius: 10px; border: 1px solid var(--border); background: var(--surface-2); color: var(--text); }
.ratio-sep { color: var(--muted); font-weight: 600; }
.color-btn { display: inline-flex; align-items: center; gap: 8px; padding: 10px 12px; border-radius: 10px; border: 1px solid var(--border); background: var(--surface-2); color: var(--text); }
.v-color-picker__controls, .v-picker__body {background-color: var(--surface-2) !important;}
.swatch { width: 16px; height: 16px; border-radius: 4px; border: 1px solid var(--border); display: inline-block; }
.picker-wrap { padding: 8px; background: var(--surface); border: 1px solid var(--border); border-radius: 12px; }
.segmented { display: inline-flex; border: 1px solid var(--border); border-radius: 10px; overflow: hidden; }
.segmented button { padding: 10px 12px; background: var(--surface-2); border: none; color: var(--text); cursor: pointer; }
...
.wallpaper-placeholder { color: var(--muted); font-size: 13px; padding: 24px; border: 1px dashed var(--border); border-radius: 12px; background: var(--surface-2); }

.v-sheet {background-color: var(--surface-2) !important;}
</style>
